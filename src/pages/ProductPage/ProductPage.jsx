...
export default function ProductPage() {
  ...
  const filteredProducts = products.filter(
    (productData) => productData.category === product.category
  );
      ...
      <section className="single-product mt-20 mb-40">
        <div className="container">
          <div className="grid lg:grid-cols-2 p-12 gap-x-4">
            <div className="">
              <a href="pics/product-1.jpg" className="image-popup">
                <img
                  src={product.img}
                  className="img-fluid"
            ...
            <div className=" flex flex-col gap-y-4 mt-5">
              <h1 className=" font-YekanHeavy text-4xl text-black dark:text-white">
                {product.name}
              </h1>
              <div className="rating flex ">
                ...
                <p className="text-left font-YekanMedium dark:text-white mr-4">
                  <a href="#" className="mr-2">
                    {product.vote} <span>رای</span>
                  </a>
                </p>
                <p className="text-left font-YekanMedium dark:text-white">
                  <a href="#" className="mr-2">
                    {product.sell} <span>فروخته شده</span>
                  </a>
                </p>
              </div>
              <p>
                <span className=" font-YekanMedium text-xl dark:text-white">
                  12.000 تومان
                </span>
              </p>
              ...
              <div className="my-4">
                <div className=" mb-3 rounded-0 flex flex-wrap">
                  <button
                    onClick={decrement}
                    id="btn_reduce"
                    className="bg-gray-300  px-4 py-2 rounded-0 "
                    type="button"
                  >
                    -
                  </button>
                  ...
                  <input
                    ...
                    type="text"
                    className="text-center w-[100px]  px-2 py-2 border outline-none focus:outline-none"
                    id="input_number"
                    value={count}
                  />
                  <button
              ...
              <h5 className="font-YekanMedium text-sm dark:text-white">
                موجودی {product.stock} کیلوگرم
              </h5>
              <button
                onClick={handleAddToCart}
                type="button"
                className=" bg-black sm:w-[40%] rounded-2xl text-white font-YekanMedium text-xl
           hover:bg-[#82ae46] transition-all my-4 p-3 px-5 fs-6"
              >
                اضافه به سبد خرید
              </button>
            </div>
      ...
      <section className="mt-[100px] mb-[100px]">
        <div className="container">
          <HeaderSection
            ...
            subHeading="سلامتی خود را تضمین کنید"
          />
